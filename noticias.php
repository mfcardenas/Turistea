                    ...
                    <div class="modal-body">
                        <form action="function/validaNoticia.php" enctype="multipart/form-data" method="POST">
				            ...
				            <div class="input-group">
				                <span class="input-group-addon"><em class="glyphicon glyphicon-leaf"></em></span>
				            ...
				            <label for="resumennoticia" class="label">· Introduzca un resumen de la misma: </label>
				            <div class="input-group">
				                <span class="input-group-addon"><em class="glyphicon glyphicon-align-left"></em></span>
				            ...
				            <div class="centrado">
				            	...
				            	<label for="botonResetearNoticia" class="invisible">Reset</label><input id="botonResetearNoticia" name="botonResetearNoticia" class="btn btn-lg btn-primary" type="reset" value="Restaurar campos">
