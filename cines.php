    ...
    <body> 
        ...
        <div class="container">
            <div class="contenido">           
	            ...
	            <h2 class="text-center"> Nuestros cines madrileños </h2>
	            <div class="row">
	            	<!--Ruta donde te encuentras -->
	            	<ol class="breadcrumb">
					  	<li><a href="index.php">Inicio</a></li>
					  	<li class="active">Cines</li>
					</ol>
	            </div>
	            <div class="row">
	            	<div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="function/insertar_lugar.php?lugar=cine" enctype="multipart/form-data" method="post" >
                             ...
                             <input type="text" class="form-control" placeholder="Nombre del cine" id ="nombre" name="nombre" required>
                            <br>
