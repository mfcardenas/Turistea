...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2017 a las 22:45:01
...
(6, 'Experiencia', 'imgGaleria/descarga.png', 'Lugar', 'paloguti', 'AnÃ©cdota');
...
(4, 'Nombre del lugar', NULL, 'Calle, NÂº', 0, '', '', '');
...
('Nombre del producto', 'imgTienda/descarga.png', '8.00'),
...
('Producto', 'imgTienda/imagen-prueba-nivel.jpg', '20.00'),
...
('David', 'david', 'david', 'david@david.com', 'normal'),
('Gema', 'gema', 'gema', 'gema@gema.com', 'normal'),
('Paloma', 'paloguti', 'paloguti', 'paloguti@ucm.es', 'admin'),
('Paloma', 'paloma', 'paloma', 'paloma@paloma.com', 'normal');
...
('Nombre del lugar', 'imgVisitas/320px-Puente_Ferroviario_Nueva_Imperial.jpg', 'DescripciÃ³n'),
