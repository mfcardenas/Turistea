...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2017 a las 09:10:08
...
`ID` int(11) NOT NULL,
  ...
  `Foto4` varchar(40) NOT NULL,
  `Parrafo5` text NOT NULL,
  `Foto5` varchar(40) NOT NULL
