                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="function/insertar_lugar.php?lugar=parque" enctype="multipart/form-data" method="post" >
                             ...
                             <input type="text" class="form-control" placeholder="Nombre del parque" name="nombre" id="nombre" required>
                            <br>
                            <p>Introduce una imagen*: </p>
                            <input type="file" id="imagen" name="imagen" required>
                            <br>
				      	     <p> Introduzca una descripción acerca del mismo: </p>
				      	     <textarea class="form-control" name="descripcion" id="descripcion" rows="3" placeholder="Escriba aquí la descripcion"></textarea>
						    <br>
							...
							<br>
							 ...
							 <input type="text" class="form-control" placeholder="Teléfono" name="telefonoparque">
							<br>
